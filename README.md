...
* **사람인HR**
  * **iOS 앱 개발 리딩** (출시 30여 종)
  * **Objective-C → Swift 전환**, **RxSwift + MVVM 도입**으로 코드 일관성·유지보수성 향상
  * **JavaScript Bridge 모듈화·가이드화**로 웹/앱 협업 비용 대폭 감소
  * **알림 수신 통계 시스템 제안·구현**으로 데이터 기반 알림 전략 수립 기반 마련

* **핀크(Finnq)**
  * **Tuist 기반 Modular 아키텍처** 설계·도입 — 모듈 의존성 정리 및 빌드 최적화로 빌드 시간 단축, 병렬 개발 환경 확보
...
### **3. JavaScript Bridge 모듈화 및 협업 체계 구축 (사람인HR, 2019)**
...
### **4. 알림 수신 통계 시스템 제안 및 구축 (사람인HR, 2017)**
