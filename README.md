...
* **사람인HR**
  ...
  * 30여 개 앱 유지보수 경험
  * **Objective-C → Swift 전환**, **RxSwift + MVVM 도입**으로 개발 효율성 개선
  * **웹 브릿지 구조 개선 및 가이드화**로 협업 효율 향상
  * **알림 통계 시스템** 제안·구현으로 사용자 참여도 개선

* **핀크(Finnq)**

  * **Tuist 기반 Microfeatures 아키텍처** 도입 → 기능 독립성·테스트 용이성·개발 속도·유지보수 효율 모두 향상
  * **SwiftLint, SwiftGen, Fastlane** 도입 및 운영으로 코드 품질·자동화 수준 강화

* **개발 철학**

  * 새로운 기술을 빠르게 학습·적용하되, 팀 상황에 맞는 **점진적·지속 가능한 도입**을 지향
  * **안정적이고 확장 가능한 앱**을 통해 사용자에게 실질적 가치 제공
